...
public class NonGenDemo {
	...
	public static void main(String[] args) {
		...
		iOb = strOb;
		v = (Integer) iOb.getob(); // run-time error caused by careless explicit casts can be prevented if the compiler has knowledge of the type of data being worked with - which is provided by generics.
	}
